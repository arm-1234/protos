...
// Validate checks the field values on RespondToCancellationResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RespondToCancellationResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RespondToCancellationResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// RespondToCancellationResponseMultiError, or nil if none found.
func (m *RespondToCancellationResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *RespondToCancellationResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, RespondToCancellationResponseValidationError{
					field:  "Order",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return RespondToCancellationResponseValidationError{
				field:  "Order",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return RespondToCancellationResponseMultiError(errors)
	}

	return nil
}

// RespondToCancellationResponseMultiError is an error wrapping multiple
// validation errors returned by RespondToCancellationResponse.ValidateAll()
// if the designated constraints aren't met.
type RespondToCancellationResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RespondToCancellationResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RespondToCancellationResponseMultiError) AllErrors() []error { return m }

// RespondToCancellationResponseValidationError is the validation error
// returned by RespondToCancellationResponse.Validate if the designated
// constraints aren't met.
type RespondToCancellationResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RespondToCancellationResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RespondToCancellationResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RespondToCancellationResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RespondToCancellationResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RespondToCancellationResponseValidationError) ErrorName() string {
	return "RespondToCancellationResponseValidationError"
}

// Error satisfies the builtin error interface
func (e RespondToCancellationResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRespondToCancellationResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RespondToCancellationResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RespondToCancellationResponseValidationError{}
